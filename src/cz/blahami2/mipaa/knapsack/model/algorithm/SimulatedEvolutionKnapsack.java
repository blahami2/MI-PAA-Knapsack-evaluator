 ...
 */
public class SimulatedEvolutionKnapsack extends Algorithm<EvolutionConfiguration> {
...
//    }
    ...
    public SimulatedEvolutionKnapsack( int warmupCycles, int runCycles ) {
    ...
    public KnapsackConfig solve( Knapsack knapsack, EvolutionConfiguration evolutionConfiguration ) {
        ...
        for ( int counter = 0; counter < evolutionConfiguration.getNumberOfGenerations(); counter++ ) {
            ...
            if ( resultConfig == null
                 || resultConfig.evaluateCost() < bestConfig.evaluateCost() ) {
